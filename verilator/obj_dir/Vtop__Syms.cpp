...
Vtop__Syms::Vtop__Syms(VerilatedContext* contextp, const char* namep, Vtop* modelp)
    ...
    , TOP{this, namep}
    , TOP__top__DOT__i_bridge{this, Verilated::catName(namep, "top.i_bridge")}
    ...
    , TOP__top__DOT__mips__DOT__i_fifo{this, Verilated::catName(namep, "top.mips.i_fifo")}
    ...
    , TOP__top__DOT__mips__DOT__i_stallDetect{this, Verilated::catName(namep, "top.mips.i_stallDetect")}
{
    ...
    TOP.__PVT__top__DOT__i_bridge = &TOP__top__DOT__i_bridge;
    ...
    TOP.__PVT__top__DOT__mips__DOT__i_fifo = &TOP__top__DOT__mips__DOT__i_fifo;
    ...
    TOP__top__DOT__i_bridge.__Vconfigure(true);
    ...
    TOP__top__DOT__mips__DOT__i_fifo.__Vconfigure(true);
